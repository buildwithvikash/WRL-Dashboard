...
export const exportDashboardConfigs = tryCatch(async (req, res) => {
  ...
  const fieldDocs = [
    ...
    ["LineTaktTime1", "Cycle time in seconds for Station 1 (e.g. 40)."],
    [
      "LineMonthlyProduction1",
    ...
    ["LineTaktTime2", "Cycle time in seconds for Station 2."],
