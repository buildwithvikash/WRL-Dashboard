...
ORDER BY HourTime;`;
  ...
  try {
    ...
    throw new AppError(`Failed to fetch Final HP Frz hourly loading data: ${error.message}`, 500);
  }
});
...
ORDER BY HourTime;`;
  ...
  try {
    ...
    throw new AppError(`Failed to fetch Final HP Choc hourly loading data: ${error.message}`, 500);
  }
});
...
ORDER BY HourTime;`;
  ...
  try {
    ...
    throw new AppError(`Failed to fetch Final HP SUS hourly loading data: ${error.message}`, 500);
  }
});
...
ORDER BY TotalCount DESC;`;
  ...
  try {
    ...
    throw new AppError(`Failed to fetch Final HP CAT loading data: ${error.message}`, 500);
  }
});
...
WITH FilteredActivity AS (
  ...
  WHERE
    ...
    AND b.ActivityType = 5
    AND b.StationCode IN (1220003, 1230007)
    AND b.ActivityOn BETWEEN @StartTime AND @EndTime
),
Grouped AS (
  SELECT
...
ORDER BY HourTime;`;
  ...
  try {
    ...
    throw new AppError(`Failed to fetch Post Foaming HP Frz hourly loading data: ${error.message}`, 500);
  }
});
...
WITH FilteredActivity AS (
  ...
  WHERE
    ...
    AND mb.Type NOT IN (200)
    AND b.ActivityType = 5
    AND b.StationCode IN (1220004, 1230007)
    AND b.ActivityOn BETWEEN @StartTime AND @EndTime
),
Grouped AS (
  SELECT
...
ORDER BY HourTime;`;
  ...
  try {
    ...
    res.status(200).json({
      success: true,
      message: "Manual Post Foaming HP hourly loading data fetched successfully",
      data,
    });
  } catch (error) {
    throw new AppError(`Failed to fetch Manual Post Foaming HP hourly loading data: ${error.message}`, 500);
  }
});
...
ORDER BY HourTime;`;
  ...
  try {
    ...
    throw new AppError(`Failed to fetch Post Foaming HP SUS hourly loading data: ${error.message}`, 500);
  }
});
...
ORDER BY TotalCount DESC;`;
  ...
  try {
    ...
    throw new AppError(`Failed to fetch Post Foaming HP CAT loading data: ${error.message}`, 500);
  }
});
...
ORDER BY HourTime;`;
  ...
  try {
    ...
    throw new AppError(`Failed to fetch Foaming HP FOM A hourly loading data: ${error.message}`, 500);
  }
});
...
ORDER BY HourTime;`;
  ...
  try {
    ...
    throw new AppError(`Failed to fetch Foaming HP FOM B hourly loading data: ${error.message}`, 500);
  }
});
...
ORDER BY TotalCount DESC;`;
  ...
  try {
    ...
    throw new AppError(`Failed to fetch Foaming HP FOM CAT loading data: ${error.message}`, 500);
  }
});