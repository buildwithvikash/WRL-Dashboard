              ...
              <div className="space-y-2">
                {sorted.slice(0, 5).map((s, i) => {
                  ...
                  return (
                    <div
                      key={i}
                      className={`flex items-center gap-3 py-2.5 px-3 rounded-xl ${bgColor}`}
                    >
                      <div
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex justify-between items-center mb-1">
                          <span className="text-sm text-slate-700 font-bold truncate max-w-[180px]">
                            {s.StationName}
                          </span>
                          <span
