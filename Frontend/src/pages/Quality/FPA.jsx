            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 border border-slate-200 rounded-lg px-3 py-2 text-xs text-slate-700 outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100 transition-all"
                />
                <button
                  onClick={getAssetDetails}
                  disabled={loading}
                  className="px-4 py-2 rounded-lg bg-indigo-600 text-white text-sm font-semibold hover:bg-indigo-700 disabled:opacity-50 transition cursor-pointer"
                >
                  {loading ? "…" : "Search"}
                </button>
              </div>
