...
// SQL returns 'SCANNED' or 'NOT SCANNED' (with space)
...
const PipelineBar = ({ label, scanned, total, icon: Icon, color }) => {
  ...
  const barColors  = { blue: "bg-blue-500",    emerald: "bg-emerald-500", violet: "bg-violet-500" };
  const textColors = { blue: "text-blue-600",  emerald: "text-emerald-600", violet: "text-violet-600" };
  return (
          ...
          <div className="flex flex-wrap gap-3 items-end">
            <div className="flex-1 min-w-[160px]">
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Serial, Material, Vehicle, Doc…"
                  value={searchTerm}
              ...
              <table className="w-full text-xs">
                <thead className="sticky top-0 z-10">
                  <tr className="bg-gray-50 border-b border-gray-200 text-gray-500 uppercase tracking-wider">
                    {[
                      ["#",               FiHash],
                      ["FG Serial No",    FiPackage],
                      ["Material Name",   FiGrid],
                      ["Doc No",          FiMonitor],
                      ["Label Print",     FiTag],
                      ["Label Date",      FiCalendar],
                      ["Auto Scan",       FiZap],
                      ["Auto Scan Date",  FiCalendar],
                      ["Unloading",       FiAnchor],
                      ["Unloading Date",  FiCalendar],
                      ["Session ID",      FiLayers],
                      ["Vehicle No",      FiTruck],
                      ["Dock No",         FiMapPin],
                ...
                <tbody>
                  {filteredData.map((row, i) => (
                    <tr key={i} className="border-t border-gray-100 hover:bg-gray-50 transition-colors">
                      ...
                      {/* FG_Unloading is always 'SCANNED' per the SQL */}
                      <td className="px-4 py-2.5"><ScanBadge status={row.FG_Unloading} /></td>
